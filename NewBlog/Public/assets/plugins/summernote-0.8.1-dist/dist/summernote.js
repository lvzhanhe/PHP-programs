...
(function (factory) {
  ...
  var renderer = {
    create: function (markup, callback) {
      return function () {
        ...
        // console.log(new Renderer(markup, children, options, callback));
  ...
  var editTitle = renderer.create('<input name="abc" type="text" class="note-editTitle"/>');
  ...
  var Editor = function (context) {
    var self = this;
    // console.log(context.layoutInfo.editable);
  ...
  var Fullscreen = function (context) {
    ...
    this.toggle = function () {
      var resize = function (size) {
        $editable.parents('.note-editing-area').css('height', size.h);
        $editable.css('height', size.h/4*3);
